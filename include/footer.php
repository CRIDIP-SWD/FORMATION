...
<div class="page-footer">
    <div class="page-footer-inner"> 2015 &copy; CRIDIP-SWD: NUM IND12209LOP.</div>
...
<script src="<?= ROOT,ASSETS,JS; ?>layout.min.js" type="text/javascript"></script>
<script src="<?= ROOT,ASSETS,JS; ?>demo.min.js" type="text/javascript"></script>
<script src="<?= ROOT,ASSETS,JS; ?>quick-sidebar.min.js" type="text/javascript"></script>
